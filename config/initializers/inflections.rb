...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular("informeauditoria", "informesauditorias")
  inflect.irregular("informefinanciero", "informesfinancieros")
  inflect.irregular("informenarrativo", "informesnarrativos")
