...
module Cor1440Gen
  class MedicionHelperTest < ActionView::TestCase
    ...
    test "números e identificadores" do
      # números
      assert_equal true, revisa_sintaxis_expresion(' 1 ')
      assert_equal true, revisa_sintaxis_expresion("\n1,0\t")
      assert_equal true, revisa_sintaxis_expresion('-2')
      assert_equal true, revisa_sintaxis_expresion("-2,0")
      assert_equal false, revisa_sintaxis_expresion('1,')
      assert_equal false, revisa_sintaxis_expresion(',1')
      assert_equal false, revisa_sintaxis_expresion('1, 0')
      # identificadores
      assert_equal true, revisa_sintaxis_expresion('m')
      assert_equal true, revisa_sintaxis_expresion('_m')
      assert_equal true, revisa_sintaxis_expresion('_m0')
      assert_equal true, revisa_sintaxis_expresion('_0')
      assert_equal false, revisa_sintaxis_expresion('0_')
      assert_equal true, revisa_sintaxis_expresion(" Ñ\t")
      assert_equal true, revisa_sintaxis_expresion('mujeres_lactantes')
      assert_equal true, revisa_sintaxis_expresion('Actividades')
      assert_equal true, revisa_sintaxis_expresion('fecha')
      assert_equal true, revisa_sintaxis_expresion('Actividades_contribuyentes')
      assert_equal true, revisa_sintaxis_expresion('Efectos_contribuyentes')
    end
    ...
    test "aplicación funcional" do
      ...
      #   [[1,2], [3,4]] ->[1,2,3,4]
      assert_equal true, revisa_sintaxis_expresion('primera(actividades)')
      assert_equal true, revisa_sintaxis_expresion('primero(actividades)')
      assert_equal true, revisa_sintaxis_expresion('ultima(actividades)')
      assert_equal true, revisa_sintaxis_expresion('ultimo(actividades)')
      assert_equal true, revisa_sintaxis_expresion('cuenta(actividades)')
      assert_equal true, revisa_sintaxis_expresion('cuenta(actividades)')
      assert_equal true, revisa_sintaxis_expresion('únicas(actividades)')
      assert_equal true, revisa_sintaxis_expresion('únicos(actividades)')
      assert_equal true, revisa_sintaxis_expresion('mapeaproy(actividades, poblacion)')
      assert_equal true, revisa_sintaxis_expresion('suma(mapeaproy(actividades, poblacion))')
      # Cuenta de actividades
      assert_equal true, revisa_sintaxis_expresion('cuenta(actividades)')
      # Cuenta población
      assert_equal true, revisa_sintaxis_expresion('suma(mapa(actividades, poblacion))')
      # Cuenta asistentes
      assert_equal true, revisa_sintaxis_expresion('cuenta(aplana(mapa(actividades, asistentes)))')
      # Cuenta asistentes únicos
      assert_equal true, revisa_sintaxis_expresion('cuenta(unicos(aplana(mapa(actividades, asistentes))))')
      # Cuenta organizaciones
      assert_equal true, revisa_sintaxis_expresion('cuenta(aplana(mapa(actividades, organizaciones)))')
      # Cuenta organizaciones únicas
      assert_equal true, revisa_sintaxis_expresion('cuenta(unicos(aplana(mapa(actividades, organizaciones))))')
      #
      assert_equal true, revisa_sintaxis_expresion('cuenta(actividades)')
    end
    ...
    test "menos" do
      assert_equal true, revisa_sintaxis_expresion('-cuenta(actividades)')
      assert_equal true, revisa_sintaxis_expresion('-1')
      assert_equal true, revisa_sintaxis_expresion('- 1,4')
    end

    # Operaciones binarias y paréntesis
    test "binarias y paréntesis" do
      assert_equal true, revisa_sintaxis_expresion('(1)')
      assert_equal true, revisa_sintaxis_expresion('(e)')
      assert_equal true, revisa_sintaxis_expresion('1+2')
      assert_equal true, revisa_sintaxis_expresion('1*2')
      assert_equal true, revisa_sintaxis_expresion('1/2')
      assert_equal true, revisa_sintaxis_expresion('1-2')
      assert_equal true, revisa_sintaxis_expresion('1+x')
      assert_equal true, revisa_sintaxis_expresion('x*100/50')
      assert_equal true, revisa_sintaxis_expresion('x*(100/50)')
    end


    test "valor de propiedad" do
      assert_equal true, revisa_sintaxis_expresion('primera(actividades).poblacion')
      assert_equal true, revisa_sintaxis_expresion('ultima(actividades).fecha')
    end
